...
export const experience = [
  ...
  { id: "bloomwright", company: "Bloomwright Realtors", period: "Jan 2020 — Jun 2020" },
  { id: "brandDigital", company: "Brand and Digital", period: "Oct 2019 — Apr 2021" },
...
export const skills = [
  "Digital Marketing", "Social Media Management", "SEO", "Performance Marketing",
  "Google Ads", "Facebook Ads Manager", "PPC", "WordPress e-Commerce",
  "Instagram Marketing", "Paid Social", "Conversion Rate Optimization",
  "Content Marketing", "Email Marketing", "Go-to-Market Strategy",
  "Brand Strategy", "Lead Generation",
] as const;

export const tools = [
  "Figma", "Photoshop", "Illustrator", "Premiere Pro", "Adobe XD", "Canva",
  "VS Code", "Git", "WordPress", "Webflow", "Wix", "Shopify", "Hostinger", "Slack",
] as const;
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    deliverables: [
      "Static banner ads", "Carousel creatives", "Retargeting ads",
      "E-commerce creatives", "Lead generation ads", "UGC-style concepts",
    ],
  ...
  },
  {
    ...
    summary:
      "Modern third-party risk management platform built on Craft CMS.",
    description: [
...
export const navSections = [
  "about", "services", "work", "results", "experience", "skills", "contact",
] as const;
